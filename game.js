...
//function of get random number
function getRandomInt(max) {
  return Math.floor(Math.random() * max);
}

//set up the content
const cookieContent = document.getElementById('cookie');

//the sentences of content
const sentences = [
  ...
  //get random one and put it into the html
  cookieContent.innerText = sentences[getRandomInt(sentences.length)];